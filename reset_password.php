...
// Mock Reset: In real world, send email. Here, just ask for new password if username exists.
// Security Note: This implementation is WEAK (anyone can reset if they know username). 
// User asked for "Basic". In production, verify old password or use email token.
...
<head>
    ...
    <title>Reset Password - UFAA Manager</title>
