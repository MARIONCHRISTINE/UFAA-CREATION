...
<head>
    ...
    <title>Login - UFAA Data Manager</title>
...
<body>
    <div class="glass-card auth-card fade-in">
        <h2 style="text-align: center; margin-bottom: 2rem;">Welcome Back (Data)</h2>
        ...
        <form method="POST" action="">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem;">
                ...
                <a href="reset_password_data.php" style="color: var(--primary-color); font-size: 0.9rem;">Forgot Password?</a>
            </div>
        ...
        <p style="text-align: center; margin-top: 1.5rem; color: var(--text-muted);">
            Don't have an account? <a href="register_data.php" style="color: var(--primary-color);">Register</a>
        </p>
    </div>
</body>
</html>
